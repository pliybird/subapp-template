					...
					<slot name="left">
						<view class="header_left_info" :class="[isTwoBtn ? 'header_btnMongol' : '' , isWhite && isTwoBtn ? 'header_colorWhite_btnMongol' : '']" v-if="back || $slots.left || home">
							<view class="header_left_back" :class="[ isTwoBtn ? 'header_btnMongol_left_back' : '' ]" v-if="back && !firstPage" @click="onBackPage">
								<image class="header_icon" v-if="isWhite" src="/static/vyung-navbar/icon_back_white.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/vyung-navbar/icon_back_black.png" mode="aspectFit"></image>
							</view>
							...
							<view class="header_left_home" :class="[isTwoBtn ? 'header_btnMongol_left_home' : '']" v-if="(firstPage && back) || home" @click="onBackHome">
								<image class="header_icon" v-if="isWhite" src="/static/vyung-navbar/icon_home_white.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/vyung-navbar/icon_home_black.png" mode="aspectFit"></image>
							</view>
						</view>
					</slot>
			...
			<view class="header_content">
				<view class="header_left_box">
					...
					<slot name="transparentFixedLeft">  
						...
						>
							<view class="header_left_back" :class="[ isTwoBtn ? 'header_btnMongol_left_back' : '' ]" v-if="back && !firstPage" @click="onBackPage">
								<image class="header_icon" v-if="isWhite" src="/static/vyung-navbar/icon_back_black.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/vyung-navbar/icon_back_white.png" mode="aspectFit"></image>
							</view>
							<text class="header_left_line" v-if="isTwoBtn"></text>
							<view class="header_left_home" :class="[isTwoBtn ? 'header_btnMongol_left_home' : '']" v-if="(firstPage && back) || home" @click="onBackHome">
								<image class="header_icon" v-if="isWhite" src="/static/vyung-navbar/icon_home_black.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/vyung-navbar/icon_home_white.png" mode="aspectFit"></image>
							</view>
						</view>
					</slot>
...
const mainPagePath = ['pages/purchase/detail'];
//返回首页的地址
const homePath = '/pages/index/home';
//白色表达值
